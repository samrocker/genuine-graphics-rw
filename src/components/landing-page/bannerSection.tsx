    ...
    <section className="mt-16">
      <main className="max-w-[1440px] m-auto">
        <div className="px-5 py-5 w-full flex-center">
          <div className="px-5 py-10 w-full flex-center flex-col gap-7 bg-white/10 rounded-3xl">
            <h1 className="text-3xl md:text-4xl lg:text-5xl text-center text-white font-bold max-w-[650px]">
              Become part of the Genuine Graphics
            </h1>
            
            <p className="text-lg text-center text-white font-medium max-w-[400px]">
